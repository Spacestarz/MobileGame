...
//using System;
//using ListsExtensionsOLDSCRIPT;
//using System.Linq;
//using UnityEngine.Events;

//public class CardManagerOLDSCRIPT : MonoBehaviour
//{
//    [SerializeField]  int _howManyCards = 52;
//    [SerializeField]  int _maxAmountCards = 52;
//    private distributeCardsOLDSCRIPT _distributeCards;

//    public TextMeshProUGUI _cardCountText;
//    public TextMeshProUGUI _DiscardPileCountText;

//    public List<CardOldScript> allCardsList;

//    public List <CardOldScript> DiscardList;

//    //make an object pool with the cards? yes i think so i can just reuse cards and have them in a discard pile maybe?

//    void Start()
//    {
//        _distributeCards = GetComponent<distributeCardsOLDSCRIPT>();
//        allCardsList = new List<CardOldScript>();
//        DiscardList = new List<CardOldScript>();

//        //makes one card
//        var card = new CardOldScript((CardOldScript.SuitEnum)1, 5);
...
//            {
//                var wholedeck = new CardOldScript((CardOldScript.SuitEnum)s, r);
