...
//public class DropZoneOLDSCRIPT : MonoBehaviour
//{
//    public List <CardOldScript> _dropzoneCardList;
//    private CardOldScript card;
//    //public TextMeshProUGUI _dropZoneText;
//    private GameObject _cardmanagerObject;
//    private CardManagerOLDSCRIPT _cardManagerScript;
//    private PlayerHandOLDSCRIPT _playerhand;
//    private SpawnLocationsPlayerOLDSCRIPT _spawnLocation;
//    private TouchandMouseInputsOLDSCRIPT _touchandMouseInputs;
//    public CardUIHandlerOLDSCRIPT _CardUIHandler;
...
//         _touchandMouseInputs = Object.FindFirstObjectByType<TouchandMouseInputsOLDSCRIPT>();
//        _cardmanagerObject = GameObject.Find("CardManager");
//        _cardManagerScript = _cardmanagerObject.GetComponent<CardManagerOLDSCRIPT>();
//        _playerhand = _cardmanagerObject.GetComponent<PlayerHandOLDSCRIPT>();
//        _spawnLocation = GetComponent<SpawnLocationsPlayerOLDSCRIPT>();

//        _dropzoneCardList = new List<CardOldScript> ();
//    }
...
//        {
//           CardOldScript card = _dropzoneCardList[0];
...
//    public void PutCardInDropZone(CardOldScript carddata, GameObject CardGameObject) 
//        //pretty sure i feck up something here make sure gameobject/visuals follow!
//    {
//        CardOldScript card = carddata;
...
//            var hoveroverDisable = CardGameObject.GetComponent<HoverOverCardOLDSCRIPT>();
...
//    public void CanCardBePlaced(CardOldScript CardData, GameObject CardObject)
//    {
//        CardOldScript FirstcardDropZone = _dropzoneCardList [0];
...
//            _touchandMouseInputs._clickedCard.GetComponent<HoverOverCardOLDSCRIPT>().enabled = false; //turn off hover script
...
//           CardOldScript FirstCardRank = _dropzoneCardList[_dropzoneCardList.Count - 1];
//           CardOldScript secondCardRank = _dropzoneCardList[_dropzoneCardList.Count - 2];
//           CardOldScript thirdCardRank = _dropzoneCardList[_dropzoneCardList.Count - 3];
//           CardOldScript fourCardRank = _dropzoneCardList[_dropzoneCardList.Count - 4];
